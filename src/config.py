...
class AuthSettings(BaseModel):
    ...
    def validate_paseto_key(cls, v: str) -> str:
        ...
        try:
            ...
            raise ValueError("PASETO_SECRET_KEY must contain only hexadecimal characters (0-9, a-f)") from e
    ...
    def validate_refresh_token_expiration(cls, v: int) -> int:
        ...
        if v > 90:
            raise ValueError("REFRESH_TOKEN_EXPIRE_DAYS should not exceed 90 days for security")
        return v
